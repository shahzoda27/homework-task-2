...
export default function Tailwind() {
  ...
  return (
    <>
   <header className='w-full  pb-[30px] bg-[#2B2B2B]'>
            {
            users.map((item,index)=>{
             return   <nav key={index} className='text-[#fff] d-flex justify-between p-[10px] pb-3'>
                 ...
                 <p>{item.title2}</p>
                 <p>{item.title3}</p>
                 <button className='  pl-[10px] pr-[10px] rounded-[8px] bg-[#A259FF]'>{item.button}</button>
                 </div>
                </nav>
            })
        }
   ...
   <section className='w-full  bg-[#2B2B2B] text-[#fff] d-flex flex-col justify-center'>
  ...
  <div className='d-flex flex-wrap gap-5 bg-[#2B2B2B] '>
   ...
   <section className='w-full  bg-[#2B2B2B] text-[#fff] d-flex flex-col pt-[50px] justify-center'>
   ...
   <section className='w-full  bg-[#2B2B2B] text-[#fff] d-flex flex-col justify-center pt-[50px]'>
    <div className='d-flex justify-around'>
        <div>
        <h1>Top creators</h1>
        <p>Checkout Top Rated Creators on the NFT Marketplace</p>
...
<div className='d-flex flex-wrap justify-center gap-5'>
   ...
   <section className='pt-[30px] bg-[#2B2B2B] w-full'>
        <img className='w-full' src={imgbg} alt="" />
   </section>
   <section className='bg-[#2B2B2B] w-full p-[20px] text-[#fff] pt-[30px] d-flex flex-col justify-center '>
